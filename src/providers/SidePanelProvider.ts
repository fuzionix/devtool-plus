            ...
            <body>
                ...
                <div id="about-container" class="pt-2 px-4" style="display: none;">
                    ...
                    <div id="about-content" class="pt-2 pb-2 border border-[var(--vscode-panel-border)] rounded-sm">
                        <h5 class="text-center">Version: <span>0.4.0 beta</span></h5>  
